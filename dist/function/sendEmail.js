...
// import helper
const validateEmail_1 = require("../helper/validateEmail");
function SendEmail(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!email) {
        ...
        else if (!(0, validateEmail_1.ValidateEmail)(email)) {
            res.status(400).json({
            ...
            try {
                const result = yield user_member_1.default.findOne({ email: { $eq: email.trim() } });
                if (!result) {
                    res.status(400).json({
